...
from swagger_client.models.update_vehicle_request import UpdateVehicleRequest  # noqa: E501
...
class TestUpdateVehicleRequest(unittest.TestCase):
    ...
    def testUpdateVehicleRequest(self):
        ...
        # model = swagger_client.models.update_vehicle_request.UpdateVehicleRequest()  # noqa: E501
        pass
