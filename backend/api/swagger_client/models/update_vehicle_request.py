...
class UpdateVehicleRequest(object):
    ...
    @property
    def status(self):
        """Gets the status of this UpdateVehicleRequest.  # noqa: E501

        The new status.  # noqa: E501

        :return: The status of this UpdateVehicleRequest.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this UpdateVehicleRequest.

        The new status.  # noqa: E501

        :param status: The status of this UpdateVehicleRequest.  # noqa: E501
        :type: str
        """
